...
module classifier_module 
  ...
  always_ff @(posedge clk) begin
    if (edit_mode == 1) begin
        case (feature_index) 
            (0): brow_threshold  <= 17'h00600;
            (1): nose_threshold  <= 17'h00200;
            (2): eyer_threshold  <= 17'h00100;
            (3): mouth_threshold <= 17'h004E0;
            (4): eyel_threshold  <= 17'h00110;
            (5): chin_threshold  <= 17'h000F0;
            /*(0): brow_threshold  <= 17'h00E50;
            (1): nose_threshold  <= 17'h004A7; 
            (2): eyer_threshold  <= 17'h00220;
            (3): mouth_threshold <= 17'h00BF8;
            (4): eyel_threshold  <= 17'h00004;
            (5): chin_threshold  <= 17'h0034C;*/
