module job_packet_builder
  ...
  next_roi nroi
     ...
     //simple face detection
          ...
          assign face_feature_brow.threshold = brow_threshold;//+{7'd0,10'd10*next_roi.roi_col_index};//4'd4;
          ...
          assign face_feature_mouth.threshold = mouth_threshold;//+{7'd0,next_roi.roi_col_index};//4'd3;
          ...
          assign face_feature_nose.threshold = nose_threshold;//+{7'd0,10'd4*next_roi.roi_col_index};//4'd2;
