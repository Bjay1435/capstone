...
HD_PWD='/home/brian/545/Geoff/Geoff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_loopback_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dma_loopback_wrapper.tcl
