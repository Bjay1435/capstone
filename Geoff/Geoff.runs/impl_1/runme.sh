...
HD_PWD='/home/brian/545/Geoff/Geoff.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_loopback_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dma_loopback_wrapper.tcl -notrace
